...
The ``PList`` class uses Swift-native value types instead and seamlessly translates them to/from the `PropertyListSerialization` types for you when loading or saving the plist to disk.
...
| Abstract Type | swift-plist Swift Type | Typealias |
| --- | --- | --- |
